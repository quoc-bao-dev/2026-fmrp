              ...
              child: [
                {
                  ...
                  location: null,
                  disabledDate:
                    (value?.e?.text_type === 'material' && dataMaterialExpiry?.is_enable === '1' && false) || (value?.e?.text_type === 'material' && dataMaterialExpiry?.is_enable === '0' && true),
                  dataWarehouse: value?.e?.warehouseList.map(e => ({
                    label: e?.location_name,
                    value: e?.id,
                    warehouse_name: e?.warehouse_name,
    ...
    <React.Fragment>
      ...
      <Container className={'!h-auto'}>
        <div className='h-[97%] space-y-3 overflow-hidden'>
            ...
            <div className=''>
              ...
              <div className='grid items-center grid-cols-10 gap-3 mt-2 '>
                ...
                <div className='col-span-2 '>
                  ...
                  />
                  {errExportWarehouse && <label className='text-sm text-red-500'>{dataLang?.exportToOthe_errWarehouse || 'exportToOthe_errWarehouse'}</label>}
                </div>
                {/* <div className="col-span-2 ">
                                    <label className="text-[#344054] font-normal text-sm mb-1 ">
                ...
                <div className='col-span-2'>
                  <label className='text-[#344054] font-normal text-sm'>
                    {props.dataLang?.payment_ob || 'payment_ob'} <span className='text-red-500'>*</span>
                  </label>
                  <SelectCore
                    closeMenuOnSelect={true}
                    ...
                    className={`${errObject ? 'border-red-500' : 'border-transparent'}  placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E]  font-normal outline-none border `}
                  />
                  {errObject && <label className='mb-2 text-sm text-red-500'>{props.dataLang?.payment_errOb || 'payment_errOb'}</label>}
                </div>
                <div className='col-span-2'>
                  <label className='text-[#344054] font-normal text-sm '>
                    {props.dataLang?.payment_listOb || 'payment_listOb'} <span className='text-red-500'>*</span>
                  </label>
                  {object?.value == 'other' ? (
                    <CreatableSelectCore
                    ...
                    <SelectCore
                      ...
                      className={`${errListObject ? 'border-red-500' : 'border-transparent'}  placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E]  font-normal outline-none border `}
                    />
                  )}
                  {errListObject && (
                      ...
                      <div className='w-[40px] h-h-[60px]'>
                        {option.e?.images != null ? (
                          ...
                          <div className=' w-[30px] h-[40px] object-cover  flex items-center justify-center rounded'>
                            <img src='/icon/noimagelogo.png' alt='Product Image' className='w-[30px] h-[30px] object-cover rounded' />
                          </div>
                        )}
                      </div>
                      <div>
                        <div>
                          ...
                          <h5 className='text-gray-400 font-medium text-xs 3xl:text-[12px] 2xl:text-[10px] xl:text-[9.5px] text-[9px]'>{dataLang[option.e?.text_type] || option.e?.text_type}</h5>
          ...
          <Customscrollbar className='max-h-[400px] h-[400px]  overflow-auto pb-2'>
            <div className='h-[100%] w-full'>
              {isFetching ? (
                ...
                <>
                  {listData?.map(e => (
                    <div key={e?.id?.toString()} className='grid items-start grid-cols-12 gap-1 my-1'>
                        ...
                        <div className='relative mt-5 mr-5'>
                            ...
                            formatOptionLabel={option => (
                              <div className='flex items-center justify-between py-2 cursor-pointer'>
                                <div className='flex items-center gap-2'>
                                  <div className='w-[40px] h-h-[60px]'>
                                    {option.e?.images != null ? (
                                      <img src={option.e?.images} alt='Product Image' className='object-cover rounded' />
                                    ) : (
                          ...
                          {e?.child?.filter(e => e?.location == null).length >= 2 && (
                            ...
                            >
                              ...
                              <span className='relative text-xs'>Xóa {e?.child?.filter(e => e?.location == null).length} hàng chưa chọn vị trí</span>
                            </button>
                          )}
                        </div>
                      </div>
                      <div className='items-center col-span-9'>
                        <div className={`grid-cols-5 3xl:text-[12px] 2xl:text-[10px] xl:text-[9.5px] text-[9px] border-b divide-x divide-y border-r grid `}>
                          {e?.child?.map(ce => (
                            <React.Fragment key={ce?.id?.toString()}>
                              <div className='flex flex-col items-center justify-center h-full p-1 border-t border-l '>
                                <SelectCore
                                  ...
                                  className={`${
                                    errWarehouse && ce?.location == null ? 'border-red-500 border' : ''
                              ...
                              <div className='flex items-center justify-center'>{ce?.unit}</div>
                              <div className='flex items-center justify-center  h-full p-0.5'>
                                ...
                                <InPutNumericFormat
                                  ...
                                  className={`${errQty && (ce?.toOtherQuantity == null || ce?.toOtherQuantity == '' || ce?.toOtherQuantity == 0) ? 'border-red-500 border-b' : ''}
                                                                        ${ce?.toOtherQuantity == null || ce?.toOtherQuantity == '' || ce?.toOtherQuantity == 0 ? 'border-red-500 border-b' : ''}
                                  ...
                                  onValueChange={_HandleChangeChild.bind(this, e?.id, ce?.id, 'toOtherQuantity')}
          ...
          <h2 className='font-normal bg-[white]  p-2 border-b border-b-[#a9b5c5]  border-t border-t-[#a9b5c5]'>{dataLang?.purchase_total || 'purchase_total'}</h2>
        </div>
