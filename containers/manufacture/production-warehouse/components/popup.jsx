              ...
              <div className='min:h-[170px] h-[72%] max:h-[100px]  customsroll overflow-auto pb-1 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100'>
                ...
                <div className=' w-[100%]'>
                  <HeaderTablePopup gridCols={12}>
                    ...
                    <ColumnTablePopup>{props.dataLang?.production_warehouse_export_sl || 'production_warehouse_export_sl'}</ColumnTablePopup>
                    <ColumnTablePopup>{props?.dataLang?.production_warehouse_conversion_gt || 'production_warehouse_conversion_gt'}</ColumnTablePopup>
                    <ColumnTablePopup>{props.dataLang?.production_warehouse_conversion_sl || 'production_warehouse_conversion_sl'}</ColumnTablePopup>
                      ...
                      <div className='divide-y divide-slate-200 min:h-[170px]  max:h-[170px]'>
                        {data?.items?.map(e => (
                          <div className='grid items-center grid-cols-12 hover:bg-slate-50 ' key={e.id?.toString()}>
                            ...
                            <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center break-words'>{e?.unit_data?.unit}</h6>
                            <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center mr-1'>{formatNumber(e?.quantity)}</h6>
                            <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center '>{formatNumber(e?.coefficient)}</h6>
                            <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center '>
                              {formatNumber(e?.quantity_exchange)} {e?.unit_data?.unit}
                            </h6>
                ...
                <div className='sticky bottom-0 z-10 grid flex-col justify-between grid-cols-12 mt-2 '>
                  ...
                  <div className='col-span-2 space-y-1 text-right'>
                    ...
                    <div className='font-medium text-left text-[13px]'>
                      <h3>{props?.dataLang?.production_warehouse_totalEx || 'production_warehouse_totalEx'}</h3>
                    </div>
                    <div className='font-medium text-left text-[13px]'>
