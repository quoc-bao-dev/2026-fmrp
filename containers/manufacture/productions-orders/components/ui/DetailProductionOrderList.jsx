        ...
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='flex items-center gap-0'>
            <div className='relative z-[3] flex items-center justify-center min-w-[140px]'>
              ...
              <span
                className={`absolute inset-0 flex items-center justify-center font-medium text-xs whitespace-nowrap px-4 ${processSteps?.materials_plan?.is_active ? 'text-white' : 'text-[#9295A4]'}`}
              >
                1. Kế hoạch NVL
              </span>
            </div>
