...
const ProductRow = memo(({ product, index, item, totalLength, formatNumber, handleToggleSheetDetail, isStateProvider, dataLang, openManagerComboId, setOpenManagerComboId, branchId }) => {
  ...
  return (
    ...
    >
      ...
      <h4 className='col-span-7 text-[#344054] font-normal flex items-center py-2 px-1'>
      ...
      <h4 className='col-span-6 flex items-center justify-center xl:text-sm text-xs px-1'>
            ...
            {item.showChild && (
              ...
              >
                ...
                <div className='col-span-16 grid grid-cols-23 gap-2 py-4 border-b'>
                  ...
                  <h4 className='xl:text-sm text-xs text-start text-[#9295A4] font-semibold col-span-7 px-1'>{dataLang?.Q_materials_finish_product || 'Q_materials_finish_product'}</h4>
                  ...
                  <h4 className='xl:text-sm text-xs text-center text-[#9295A4] font-semibold block col-span-6 px-1'>{dataLang?.Q_materials_progress || 'Q_materials_progress'}</h4>
                </div>
                {item.items_products &&
                  item.items_products
