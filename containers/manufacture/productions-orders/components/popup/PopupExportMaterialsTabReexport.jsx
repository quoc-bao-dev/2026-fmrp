        ...
        const preparedWarehouses = warehouseState.lotRows
          ...
          .map(row => {
            ...
            return {
              ...
              // Warehouse properties (ưu tiên lấy từ row đã chọn kho)
              value_1: row.value_1 ?? originalWarehouse.value_1 ?? null,
              value_2: row.value_2 ?? originalWarehouse.value_2 ?? null,
              value_3: row.value_3 ?? originalWarehouse.value_3 ?? null,
          ...
          <div className='flex-1 flex flex-col rounded-t-xl bg-white overflow-hidden'>
            ...
            {selectedProducts.length === 0 ? (
              ...
              <div className='overflow-hidden flex-1'>
                ...
                <Customscrollbar className='max-h-[50vh] 2xl:max-h-[50vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300'>
