...
const PopupCategory = props => {
  ...
  const [stages_unit_price, sTagesUnitPrice] = useState(0);
  ...
  useEffect(() => {
    ...
    // Ép kiểu về number để tránh trường hợp API trả về string làm PriceInput nhận 0
    sTagesUnitPrice(props.data?.price_default != null ? Number(props.data?.price_default) || 0 : 0);
  ...
  const _ServerSending = async () => {
    ...
    if (tabPage === 'stages') {
      ...
      data.append('price_default', stages_unit_price || 0);
    }
    if (tabPage === 'costs') {
                ...
                <div className='flex flex-wrap justify-between'>
                  ...
                  <div className='w-full'>
                    <label className='text-[#344054] font-normal text-sm mb-1 '>
                      ...
                      {props.dataLang?.settings_category_stages_codeAdd || 'settings_category_stages_codeAdd'}
                      <span className='text-red-500'>*</span>
                    </label>
                    <div>
                      <input
                  ...
                  <div className='w-full flex justify-between flex-wrap'>
                    <div className='inline-flex items-center w-[50%] gap-3.5'>
                      ...
                      <label htmlFor='1' className='text-[#344054] font-medium text-base  cursor-pointer '>
                ...
                <div className='py-4 space-y-5'>
                  <div className='space-y-1'>
                    <label className='text-[#344054] font-normal text-base'>
                      {props.dataLang?.expense_code || 'expense_code'} <span className='text-red-500'>*</span>
                    </label>
                    <input
                      value={costs_code}
                  ...
                  <div className='space-y-1'>
                    <label className='text-[#344054] font-normal text-base'>
                      {props.dataLang?.expense_name || 'expense_name'} <span className='text-red-500'>*</span>
                    </label>
                    <input
                      value={costs_name}
                  ...
                  <div className='col-span-6 max-h-[65px] min-h-[65px]'>
                    <label className='text-[#344054] font-normal text-base mb-1 '>
                      {props.dataLang?.expense_branch || 'expense_branch'} <span className='text-red-500'>*</span>
                    </label>
                    <Select
