    ...
    return <div className='min-h-screen relative'>
        ...
        <div className="relative z-50 flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center  gap-5">
                ...
                <button
                    type="button"
                    className="flex h-fit items-center gap-1 px-2 py-1 rounded-[31px] bg-white/70 backdrop-blur-sm transition-shadow hover:shadow-[0px_4px_13.6px_0px_rgba(3,117,243,0.28)]"
                >
                    ...
                    <p
                        className="font-medium text-[12px]- tracking-[-0.006em] text-[#003DA0] capitalize"
                    >
                        Trang quản lý
                    </p>
                </button>
