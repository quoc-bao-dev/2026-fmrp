    ...
    <PopupCustom
      ...
      button={
        props?.id ? (
          ...
          >
            <EditIcon size={20} className='size-5 transition-all duration-300 text-neutral-03 group-hover:text-neutral-07' />
            <p className='text-neutral-03 group-hover:text-neutral-07 font-normal whitespace-nowrap'>{props.dataLang?.btn_table_edit || 'btn_table_edit'}</p>
          </div>
        ) : (
              ...
              {tab === 0 && (
                <div className='grid grid-cols-2 gap-5'>
                  <div className='space-y-2 2xl:space-y-3'>
                    <div className='2xl:space-y-1'>
                      ...
                      <Select
                        ...
                        className={`${
                          errBranch && branch?.length == 0 ? 'border-red-500' : 'border-transparent'
                    ...
                    <div className='2xl:space-y-1'>
                      ...
                      <input
                        ...
                        className={`${
                          errCode && code == '' ? 'border-red-500' : 'focus:border-[#92BFF7] border-[#d0d5dd] '
                    ...
                    <div className='2xl:space-y-1'>
                      <label className='text-[#344054] font-normal 2xl:text-base text-[15px]'>
                        {props.dataLang?.name_finishedProduct} <span className='text-red-500'>*</span>
                      </label>
                      <input
                        value={name}
                        ...
                        className={`${
                          errName && name == '' ? 'border-red-500' : 'focus:border-[#92BFF7] border-[#d0d5dd] '
                        } placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E] font-normal  p-2 border outline-none`}
                      />
                  ...
                  <div className='space-y-2 2xl:space-y-3'>
                    <div className='2xl:space-y-1'>
                      <label className='text-[#344054] font-normal 2xl:text-base text-[15px]'>
                        {props.dataLang?.type_finishedProduct} <span className='text-red-500'>*</span>
                      </label>
                      <Select
                        options={dataOptType}
                        value={type}
                        ...
                        onMenuOpen={handleMenuOpen}
                        className={`${
                          errType && type?.value == null ? 'border-red-500' : 'border-transparent'
                        } placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E] font-normal outline-none border `}
                        theme={theme => ({
                          ...theme,
                          colors: {
                    ...
                    <div className='2xl:space-y-1'>
                      ...
                      <Select
                        ...
                        onMenuOpen={handleMenuOpen}
                        className={`${
                          errUnit && unit?.value == null ? 'border-red-500' : 'border-transparent'
                        } placeholder:text-slate-300 w-full bg-[#ffffff] rounded text-[#52575E] font-normal outline-none border `}
                        theme={theme => ({
                          ...theme,
                          colors: {
                      ...
                      <div className='flex justify-center'>
                        <div className='relative rounded h-36 w-36 bg-slate-200'>
                          ...
                          <div className='absolute bottom-0 flex flex-col space-y-2 -right-12'>
                            ...
                            <label htmlFor={`upload`} title={props.dataLang?.edit || 'edit'} className='flex flex-col items-center justify-center w-8 h-8 rounded-full cursor-pointer bg-slate-100'>
                              <IconEditImg size='17' />
                            </label>
                            <button
                        ...
                        <div className='flex flex-col'>
                          {optVariantMain?.map(e => (
                            <div key={e?.id.toString()} className='flex items-center '>
                              ...
                              <label htmlFor={e.id} className='text-[#344054] font-normal text-sm cursor-pointer'>
                                {e.name}
                              </label>
                            </div>
                          ))}
