  ...
  return (
    <div className='min-h-screen relative'>
      <LayOutTableDynamic
        ...
        titleButton={
          <>
            <h2 className='text-title-section text-[#52575E] capitalize font-medium'>{dataLang?.list_finishedProduct_title}</h2>
                      ...
                      {data?.rResult?.map(e => (
                        <RowTable key={e?.id.toString()} gridCols={13}>
                          ...
                          <RowItemTable colSpan={2} textAlign={'left'} className='flex flex-col items-start justify-start gap-y-[4px]'>
                            ...
                            <TagColorProduct dataLang={dataLang} dataKey={e?.type_products?.id} name={e?.type_products?.name} className='!px-1' textSize='text-[11px]' />
                            {/* </h6> */}
                          </RowItemTable>
                          ...
                          <RowItemTable colSpan={1} className='flex items-center justify-center'>
                            {Number(e?.ct_versions_stage) == 0 ? '' : <IconTick className='text-green-500' />}
                          </RowItemTable>
                          <RowItemTable colSpan={1} textAlign={'left'}>
                            {e?.note}
                          </RowItemTable>
