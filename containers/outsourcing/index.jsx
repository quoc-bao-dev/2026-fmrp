...
const OutsourcingSteps = ({ statusKey }) => {
  ...
  return (
    <div className='flex items-center gap-0'>
      ...
      <div className='relative z-[2] flex items-center justify-center min-w-[70px] -ml-[13px]'>
      ...
      <div className='relative z-[1] flex items-center justify-center min-w-[70px] -ml-[13px]'>
  ...
  return (
    <div className='w-full h-full rounded-2xl border border-[#F3F4F6] bg-white shadow-sm flex flex-col overflow-hidden'>
      <Customscrollbar className='flex-1 min-h-0'>
        <div className='p-4 3xl:p-6 flex flex-col gap-4 min-h-full'>
          {/* Steps */}
          <div className="ml-8">
