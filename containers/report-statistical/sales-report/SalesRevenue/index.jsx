...
import { PiCalendar, PiPackage } from 'react-icons/pi';
  ...
  return (
    <React.Fragment>
      <ReportLayout
          ...
          <TableSection
            ...
            renderFooter={() => (
              <>
                ...
                <RowItemTable className='h-10 w-32 flex items-center justify-center px-3 text-neutral-07 !responsive-text-sm font-semibold flex-shrink-0 bg-white'>Tổng cộng</RowItemTable>
        ...
        totalSection={isState?.data?.length > 0 && <Pagination postsPerPage={limit} totalPosts={Number(isState?.total?.iTotalDisplayRecords) || 0} paginate={paginate} currentPage={currentPage} />}
