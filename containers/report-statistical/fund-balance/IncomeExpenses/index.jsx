  ...
  const columns = [
    {
      key: 'date',
      header: 'Ngày',
      thClass: 'min-w-32 h-2 p-0 text-center font-semibold text-gray-700 sticky left-0 bg-white z-20',
    ...
    },
    {
      ...
      header: 'Số chứng từ',
      thClass: 'min-w-36 h-2 p-0 text-center font-semibold text-gray-700 sticky left-32 bg-white z-20',
      tdClass: 'p-0 h-2 text-center text-gray-700 align-middle sticky left-32 z-20 bg-white',
      rowSpan: false,
