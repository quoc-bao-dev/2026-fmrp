      ...
      tableSection={
        <TableSection
          ...
          scrollableColumns={[
            ...
            ...(hasProductExpiry || hasMaterialExpiry || hasProductSerial ? [{ title: 'Thông tin', width: 'w-40', textAlign: 'left' }] : []),
          ...
          renderScrollableRow={(item, index) => (
            <>
              ...
              <RowItemTable className='flex items-center py-2 px-3 border-r border-[#E0E0E1] text-neutral-07 !responsive-text-sm font-normal w-40 flex-shrink-0'>{item.branch_name}</RowItemTable>
              <RowItemTable className='flex items-center py-2 px-3 border-r border-[#E0E0E1] text-neutral-07 !responsive-text-sm font-normal w-36 flex-shrink-0'>{item.warehouse_name}</RowItemTable>
              ...
              <RowItemTable className='flex justify-start items-center py-2 px-3 text-neutral-07 !responsive-text-sm font-normal w-52 flex-shrink-0'>{item.note}</RowItemTable>
            </>
          )}
          renderFooter={() => (
            <>
              ...
              {(hasProductExpiry || hasMaterialExpiry || hasProductSerial) && <RowItemTable className='w-40 flex-shrink-0 bg-white'></RowItemTable>}
              <RowItemTable className='w-24 flex-shrink-0 bg-white'></RowItemTable>
              <RowItemTable className='w-40 flex-shrink-0 bg-white'></RowItemTable>
              <RowItemTable className='h-10 flex items-center justify-end px-3 text-neutral-07 !responsive-text-sm font-semibold w-36 flex-shrink-0 bg-white uppercase'>Tổng cộng</RowItemTable>
              <RowItemTable textAlign={'center'} className='h-10 flex items-center justify-center px-3 text-neutral-07 !responsive-text-sm font-semibold w-20 flex-shrink-0 bg-white'>
