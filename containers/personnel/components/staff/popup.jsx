                    ...
                    <div className='w-1/2'>
                      ...
                      <div>
                        <input
                          ...
                          type='text'
                          className={`${
                            isState.errInput ? 'border-red-500' : 'focus:border-[#92BFF7] border-[#d0d5dd]'
                          } placeholder:text-slate-300 w-full bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal p-1.5 border outline-none mb-2`}
                        />

                        {isState.errInput && <label className='mb-4  text-[14px] text-red-500'>{props.dataLang?.personnels_staff_popup_errName}</label>}
                      </div>
                      <div>
                        <label className='text-[#344054] font-normal text-sm mb-1 '>
                      ...
                      <div className='flex items-center '>
                        <label className='relative flex cursor-pointer items-center rounded-full p-3 gap-3.5' for='checkbox-6' data-ripple-dark='true'>
                          <input
                            type='checkbox'
                      ...
                      <div className='relative flex flex-col mt-3'>
                        <div>
                          ...
                          <input
                            ...
                            className={`${
                              isState.errInputPas ? 'border-red-500' : 'focus:border-[#92BFF7] border-[#d0d5dd]'
                            } placeholder:text-slate-300 w-full bg-[#ffffff] rounded-[5.5px] text-[#52575E] font-normal py-2 pl-3 pr-12  border outline-none `}
                          />
                          <button type='button' onClick={() => queryState({ typePassword: !isState.typePassword })} className='absolute right-3 top-[50%]'>
                            {isState.typePassword ? <IconEyeSlash /> : <IconEye />}
                          </button>
                        </div>
                        {isState.errInputPas && <label className='mb-2  text-[14px] text-red-500'>{props.dataLang?.personnels_staff_popup_errPas}</label>}
                      </div>
                    </div>
                    <div className='w-1/2'>
                          ...
                          <div className='relative h-[180px] w-[180px] rounded bg-slate-200'>
                            {isState.thumb && (
                              <Image
                                ...
                                height={180}
                                quality={100}
                                src={typeof isState.thumb === 'string' ? isState.thumb : URL.createObjectURL(isState.thumb)}
                                alt='thumb type'
