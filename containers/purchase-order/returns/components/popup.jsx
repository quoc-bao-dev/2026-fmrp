              ...
              <div className='min:h-[170px] h-[72%] max:h-[100px]  customsroll overflow-auto pb-1 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100'>
                ...
                <div className='grid grid-cols-9  min-h-[100px] px-2 items-center bg-zinc-50'>
                  <div className='col-span-3'>
                    ...
                    <div className='grid items-center grid-cols-2 col-span-2'>
                      <h3 className=' text-[13px] font-medium'>{props?.dataLang?.production_warehouse_creator || 'production_warehouse_creator'}</h3>
                  ...
                  <div className='col-span-3'>
                    <div className='grid grid-cols-2 my-2 font-medium'>
                      <h3 className=' text-[13px] '>{props.dataLang?.returns_form || 'returns_form'}</h3>
                      <div className='flex flex-wrap items-center gap-2'>
                        {(data?.treatment_methods === '1' && <TagColorSky className={'!py-1'} name={props.dataLang?.pay_down || 'pay_down'} />) ||
                          (data?.treatment_methods === '2' && <TagColorOrange className={'!py-1'} name={props.dataLang?.debt_reduction || 'debt_reduction'} />)}
                      </div>
                    </div>
                    <div className='grid grid-cols-2 my-2 font-medium'>
                  ...
                  <div className='col-span-3 '>
                    <div className='grid grid-cols-2 my-2 font-medium'>
                      ...
                      <h3 className='text-[13px] font-medium capitalize'>{data?.supplier_name}</h3>
                    </div>
                ...
                <div className=' w-[100%]'>
                  <HeaderTablePopup gridCols={14}>
                    ...
                    <ColumnTablePopup colSpan={2}>{props.dataLang?.returns_point || 'returns_point'}</ColumnTablePopup>
                    <ColumnTablePopup>{'Tồn kho'}</ColumnTablePopup>
                    ...
                    <>
                      <Customscrollbar className='min-h-[90px] max-h-[170px] 2xl:max-h-[250px]'>
                        <div className='divide-y divide-slate-200 min:h-[170px]  max:h-[170px]'>
                          {data?.items?.map(e => (
                            <div className='grid items-center border-b grid-cols-14 hover:bg-slate-50' key={e.id?.toString()}>
                              ...
                              <h6 className='text-[13px]   px-2 py-2 col-span-2 text-left break-words'>
                                <h6 className='font-medium'>{e?.warehouse_name ? e?.warehouse_name : ''}</h6>
                                <h6 className='font-medium'>{e.location_name ? e.location_name : ''}</h6>
                              </h6>
                              ...
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center'>{formatMoney(e?.price)}</h6>
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center'>{formatNumber(e?.discount_percent) + '%'}</h6>
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center'>{formatMoney(e?.price_after_discount)}</h6>
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-center'>{formatNumber(e?.tax_rate) + '%'}</h6>
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-right '>{formatMoney(e?.amount)}</h6>
                              <h6 className='text-[13px]   py-2 col-span-1 font-medium text-left ml-3.5'>{e?.note != undefined ? <ExpandableContent content={e?.note} /> : ''}</h6>
                            </div>
                          ))}
                        </div>
                      </Customscrollbar>
