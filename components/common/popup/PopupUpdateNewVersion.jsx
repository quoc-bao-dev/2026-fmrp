      ...
      >
        ...
        {isUpdate && (
          <div className='flex flex-col items-start w-full h-fit gap-y-5'>
            <h3 className='text-typo-gray-1 font-medium text-base'>Tiến trình cập nhật:</h3>
        ...
        <div className='absolute top-0  -translate-y-1/2 select-none'>
          <Image alt='rocket' src='/popup/rocket.gif' width={600} height={600} quality={100} className='h-[130px] w-[140px] select-none' draggable={false} layout={'responsive'} unoptimized={true} />
        </div>
      </div>
    </div>
  );
