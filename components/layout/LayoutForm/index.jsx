...
const LayoutForm = ({
  ...
  return (
    <div className='min-h-screen bg-gray-50 flex flex-col gap-5'>
      ...
      <Container className='flex flex-col gap-5 flex-1 overflow-auto !space-y-0 xl:px-6 2xl:px-12 3xl:px-12 pb-16'>
      ...
      {/* Footer Actions */}
      <div className='fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-200 shadow-[0_-3px_12px_0px_#0000001A]'>
        <div className='py-2.5 2xl:py-3 px-4 xl:px-6 2xl:px-12 3xl:px-12 flex items-center justify-end gap-2'>
          <button onClick={onExit} className='px-6 py-2 2xl:py-3 responsive-text-base bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors'>
            Thoát
          </button>
          <button onClick={onSave} disabled={loading} className='px-6 py-2 2xl:py-3 responsive-text-base bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-50'>
