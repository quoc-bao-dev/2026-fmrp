    ...
    <div className=''>
      ...
      >
        ...
        >
          ...
          <div className={`3xl:px-2 3xl:py-3 2xl:px-3 2xl:py-1 xl:px-0.5 xl:py-0.5 lg:px-0.5 lg:py-0.5 2xl:space-y-2 lg:space-y-1 w-fit`}>
            <div className='space-y-0.5'>
              {onFetching ? (
                <Loading />
              ) : (
                <>
                  <TabContent subItems={props.data?.tab?.find(e => e?.id === tab)?.sub || []} checkStt={checkStt} />
...
const TabContent = ({ subItems, checkStt }) => {
  ...
  return (
    <div className='tab-content'>
      {subItems?.length === 0 ? (
        <NoData type='notificationheader' className='w-[350px]' classNameImage='!max-w-[30%] !max-h-[30%]' />
      ) : (
        <div className={`3xl:px-2 3xl:py-1  2xl:px-3 2xl:py-1 xl:px-0.5 xl:py-0.5 lg:px-0.5 lg:py-0.5 2xl:space-y-2 lg:space-y-1 w-fit`}>
